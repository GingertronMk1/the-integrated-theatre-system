...
final class Version20240203192444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $seasonsTable->addColumn('description', Types::TEXT);
        ...
        $showsTable->addColumn('description', Types::TEXT);
        $showsTable->addColumn('year', Types::STRING);
        $showsTable->addColumn('season_id', Types::GUID);
